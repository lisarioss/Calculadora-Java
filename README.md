# 🧮 Calculadora em Java | Nível Java Júnior

Projeto desenvolvido em **Java**, focado na aplicação prática dos **fundamentos da linguagem**, com organização de código, separação de responsabilidades e tratamento de exceções.

Este projeto representa minha evolução de um código inicial para um padrão mais próximo do esperado em **vagas Java Júnior**.
...
- Boas práticas para nível iniciante/júnior
